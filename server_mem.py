"""
Fully memory-profiled version of server.py.
Run with: python -m memory_profiler server_profiled.py
"""
# Memory profiler must be imported first
...
# Apply the @profile decorator to all code in this file by making a single main function
@profile
def main():
    # Server configuration
    global flights, flights_lock
    SERVER_IP = '0.0.0.0'
    SERVER_PORT = 8000
    DB_FILE = 'flights.db'
    ...
    def start_server():
        ...
        try:
            ...
            return  # Exit main function on Ctrl+C

    # Start the server
    start_server()

if __name__ == '__main__':
    main()  # Everything is inside the profiled main function